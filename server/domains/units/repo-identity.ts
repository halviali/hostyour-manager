...
//
// The owner names the organisation, and the organisation's record (organisations.ts, #219) is what
...
/** What the organisation record answers for an owner (organisations.ts readOrganisationIdentity). */
 ...
 *  fingerprint, so an audit names which App acted), or the organisation's PAT sealed again under
